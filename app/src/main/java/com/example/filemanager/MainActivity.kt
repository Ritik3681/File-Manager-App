...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var imageDisplay:LinearLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageDisplay= findViewById(R.id.images)
        val vedio=findViewById<LinearLayout>(R.id.videos)
        ...
        vedio.setOnClickListener{
            val intent=Intent(this,VideoDisplayActivity::class.java)
            startActivity(intent)
        }

        val audio=findViewById<LinearLayout>(R.id.audio)
        audio.setOnClickListener{
            val intent=Intent(this,AudioDisplaActivity::class.java)
            startActivity(intent)
        }
